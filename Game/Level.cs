...
namespace Game
{
    ...
    class Level
    {
        ...
        public void DownloadLevel(int n)
        {
            ...
            string path = SettingsGame.Content + @"Maps\" + carentLevel.ToString();
        ...
        public void Draw()
        {
            DandyTanks.ScreenGame.Invalidate(DandyTanks.ScreenGame.ClientRectangle);
        }
        ...
        public void Update()
        {
            ...
            {
                // Если вражиских танков не осталось
